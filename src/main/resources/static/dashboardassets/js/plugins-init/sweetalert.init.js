...
document.querySelector(".sweet-wrong").onclick = function () {
    ...
    document.querySelector(".sweet-confirm").onclick = function () {
        Swal.fire({ title: "Are you sure to delete ?", text: "You will not be able to recover this imaginary file !!",
    ...
    onclick = function () {
        Swal.fire({ title: "Are you sure to delete ?",
            ...
            closeOnConfirm: !1, closeOnCancel: !1 }, function (e)
        { e ? Swal.fire("Deleted !!", "Hey, your imaginary file has been deleted !!",
            "success") : Swal.fire("Cancelled !!", "Hey, your imaginary file is safe !!",
    ...
    function () {
        Swal.fire({ title: "Sweet !!",
            text: "<span style='color:#ff0000'>Hey, you are using HTML !!<span>",
            html: !0 }) }, document.querySelector(".sweet-auto").onclick =
    function () {
        Swal.fire({ title: "Sweet auto close alert !!",
            text: "Hey, i will close in 2 seconds !!", timer: 2e3,
            showConfirmButton: !1 }) }, document.querySelector(".sweet-prompt").
    onclick = function () {
        Swal.fire({ title: "Enter an input !!",
    text: "Write something interesting !!", type: "input", showCancelButton: !0,
            closeOnConfirm: !1, animation: "slide-from-top", inputPlaceholder:
                "Write something" }, function (e) { return !1 !== e && ("" === e ?
    ...
    document.querySelector(".sweet-ajax").onclick = function () {
        Swal.fire({ title: "Sweet ajax request !!", text: "Submit to run ajax request !!",
            type: "info", showCancelButton: !0, closeOnConfirm: !1,
            showLoaderOnConfirm: !0 }, function () {
            setTimeout(function () {
